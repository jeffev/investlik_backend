...
def setup_routes(app):
    ...
    app.add_url_rule('/favorites/<string:ticker>', methods=['POST'], view_func=protected_route(add_favorite_stock))
    app.add_url_rule('/favorites/<string:ticker>', methods=['DELETE'], view_func=protected_route(remove_favorite_stock))